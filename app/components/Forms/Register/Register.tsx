...
import { validateEmail, validatePassword, validatePasswordMatch, validateNames } from "../shared/validators";
...
const buildSteps = (form: RegisterFormShape): StepConfig<RegisterFormShape>[] => [
  {
    name: "email",
    label: "Email",
    type: "email",
...
export default function Register() {
  ...
  return (
    <div className="max-w-lg mx-auto">
      <h2 className="text-2xl font-semibold mb-8 text-center">Create your account</h2>
      <StepWizard
        wizard={wizard}
          ...
          return (
            <div className="flex flex-col gap-4">
              ...
              <input
                ...
                onChange={(e) => w.setValue(step.name as keyof RegisterFormShape, e.target.value)}
                autoFocus
